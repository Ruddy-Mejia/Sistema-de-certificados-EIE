    ...
    */
    ...
    public function update(Request $request)
    {
        try {
            ...
            return back()->with('status', 'Curso actualizado correctamente!');
        } catch (\Exception $e) {
            return back()->withError($e->getMessage());
        }
    }
    ...
    public function courseregister(Request $request)
    {
        try {
            $data = new Course();
            $data->nombre_curso  = $request->course_name;
            $data->carga_horaria  = $request->horaria;
            $data->metodo_estudio  = $request->metodo;
